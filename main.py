...
follow5 = my_font3.render("Димася уже выпил: 0 пива", 1, (255, 0, 0), (0, 0, 0))
follow6 = my_font.render("Лабиринт димасика - пивасика", 1, (255, 0, 0), (0, 0, 0))


def start_ok():
    screen.blit(follow, (250, 150))
    ...
    screen.blit(follow4, (450, 525))
    screen.blit(follow5, (450, 475))
    screen.blit(follow6, (190, 100))
                    ...
                    while not done:
                        ...
                        if player.down_pressed and player_rect.y > yC * hr + 2:
                            ...
                            if player.x != xC * wr + 2 and grid[x0][y0 + 1].walls[3]:
                                player.y = yC * hr + 2
                                player.down_pressed = False
                        pygame.draw.rect(screen, (255, 255, 255), (540, 540, 60, 60), 500)
